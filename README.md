...
P01 工程切片接入 BigModel 通用服务 `glm-4.7` 的语义角色配置、Windows 系统凭据与 HTTP 传输；默认 Worker/角色仍为 Codex。真实 GLM 请求及角色准入尚未验证，当前支持与配置边界见 [产品说明](clao/README.md#glm-语义角色配置p01-工程切片)。

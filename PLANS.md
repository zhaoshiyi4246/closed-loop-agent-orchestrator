...
- 当前阶段：M0 — Repository Baseline & Layout Consolidation。
- 当前任务：**V03-M0-LAYOUT**。
- 当前状态：IN_PROGRESS；V03-DOC-00 已 DONE，进入负责人授权的目录与本机副本整理。
- 当前允许：Git rename、必要路径适配、manifest／builder 定位、当前文档、完整离线测试与打包验证、本机副本分类整理。
...
| 阶段 | 状态 | 退出条件 |
|---|---|---|
| M0 基线与目录整理 | IN_PROGRESS（DOC-00 DONE） | 规划已批准入库；纯路径迁移验证；本机副本整理；OPEN PR |
